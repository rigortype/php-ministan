...
キーごとに値の型が分かる —— これが [`ConstantArrayType`](../../../impls/looking-glass/02-arrays/src/Type/Constant/ConstantArrayType.php)
...
一般の `ArrayType` に落とします（[`arrayLiteralType`](../../../impls/looking-glass/02-arrays/src/Analyser/Scope.php)）:
...
分かる今、`$v` に正しい型を与えられます
（[`processForeach`](../../../impls/looking-glass/02-arrays/src/Analyser/NodeScopeResolver.php)）:
