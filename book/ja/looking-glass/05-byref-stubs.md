...
分かります（[`FunctionReflection`](../../../impls/looking-glass/05-byref-stubs/src/Reflection/FunctionReflection.php)）:
...
その引数だけ変数を定義します（[`processCallArgs`](../../../impls/looking-glass/05-byref-stubs/src/Analyser/NodeScopeResolver.php)）:
...
[`stubs/core.php`](../../../impls/looking-glass/05-byref-stubs/stubs/core.php) は**実行されません**。シグネチャを読むためだけに
**パース**されます:
...
[`ReflectionProvider`](../../../impls/looking-glass/05-byref-stubs/src/Reflection/ReflectionProvider.php) は起動時にこれを読み、
ネイティブより優先します:
