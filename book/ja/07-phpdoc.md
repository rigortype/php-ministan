...
> ＊コードはライブ実装ツリー [`dev/`](../../dev) にあります（この章の到達点は `git tag part-07`）。
...
[`PhpDocTypeResolver`](../../dev/src/Reflection/PhpDocTypeResolver.php) の仕事です
...
[`ArrayType`](../../dev/src/Type/ArrayType.php) です:
...
（[`processExpressionStmt`](../../dev/src/Analyser/NodeScopeResolver.php)）:
