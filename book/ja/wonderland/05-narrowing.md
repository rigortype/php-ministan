...
> ＊この章のコードはスナップショット [`impls/wonderland/05-narrowing`](../../../impls/wonderland/05-narrowing) にあります（この章の到達点は `git tag part-05`）。
...
「int または string」を表す **ユニオン型**（union type、合併型とも）が要ります（[`UnionType`](../../../impls/wonderland/05-narrowing/src/Type/UnionType.php)）。
...
ユニオン型の **生成** は型クラスではなく [`TypeCombinator`](../../../impls/wonderland/05-narrowing/src/Type/TypeCombinator.php)
...
[`TypeSpecifier`](../../../impls/wonderland/05-narrowing/src/Analyser/TypeSpecifier.php)（PHPStan の同名クラスに対応）。
結果は [`SpecifiedTypes`](../../../impls/wonderland/05-narrowing/src/Analyser/SpecifiedTypes.php)（truthy/falsy の組）です。
