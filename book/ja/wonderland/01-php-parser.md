...
> ＊この章のコードはスナップショット [`impls/wonderland/01-php-parser`](../../../impls/wonderland/01-php-parser) にあります（この章の到達点は `git tag part-01`）。
...
[`NoVarDumpRule`](../../../impls/wonderland/01-php-parser/src/Rules/Functions/NoVarDumpRule.php) は型を一切使いません。
純粋な構文パターンマッチです:
...
無駄なので、**ノード種別で索引**します（[`RuleRegistry`](../../../impls/wonderland/01-php-parser/src/Rules/RuleRegistry.php)）。
...
`NodeVisitor` に乗ります（[`RuleApplyingVisitor`](../../../impls/wonderland/01-php-parser/src/Analyser/RuleApplyingVisitor.php)）:
