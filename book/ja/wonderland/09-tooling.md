...
> ＊この章のコードはスナップショット [`impls/wonderland/09-tooling`](../../../impls/wonderland/09-tooling) にあります（この章の到達点は `git tag part-09`）。
...
[`TableErrorFormatter`](../../../impls/wonderland/09-tooling/src/Output/TableErrorFormatter.php) はファイルごとにまとめ、
[`JsonErrorFormatter`](../../../impls/wonderland/09-tooling/src/Output/JsonErrorFormatter.php) は機械可読に出します:
...
**新しく入った指摘だけ**を赤にする運用にします（[`Baseline`](../../../impls/wonderland/09-tooling/src/Output/Baseline.php)）。
...
## 積み残しと、その先（ministan Through PHP's Looking-Glass）
...
応用編 **ministan Through PHP's Looking-Glass** で、これらに踏み込みます。
