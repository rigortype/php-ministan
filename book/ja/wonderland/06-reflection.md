...
> ＊この章のコードはスナップショット [`impls/wonderland/06-reflection`](../../../impls/wonderland/06-reflection) にあります（この章の到達点は `git tag part-06`）。
...
解決します（[`Parsing`](../../../impls/wonderland/06-reflection/src/Analyser/Parsing.php)）:
...
PHPStan の要のひとつ [`ReflectionProvider`](../../../impls/wonderland/06-reflection/src/Reflection/ReflectionProvider.php)。
二段構えです:
...
[`MethodReflection`](../../../impls/wonderland/06-reflection/src/Reflection/MethodReflection.php)・
[`FunctionReflection`](../../../impls/wonderland/06-reflection/src/Reflection/FunctionReflection.php) に包みます。型宣言を
{@see Type} に写すのは [`TypeNodeResolver`](../../../impls/wonderland/06-reflection/src/Reflection/TypeNodeResolver.php) の
